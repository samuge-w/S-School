...
Route::get('/license/settings', [LicenseController::class, 'settings'])->name('license.settings');
Route::post('/license/activate', [LicenseController::class, 'activate'])->name('license.activate');
Route::post('/license/generate', [LicenseController::class, 'generate'])->name('license.generate');
Route::get('/license/check', [LicenseController::class, 'check'])->name('license.check');
