...
-->
    ...
    <link href="{{ URL::asset('/assets/css/beira-unida-custom.css')}}" rel="stylesheet" media="all">
                                    ...
                                    <div class="account-dropdown__body">
                                        ...
                                        <div class="account-dropdown__item">
                                            <div style="display: flex; gap: 10px; justify-content: center;">
                                                <a href="{{url('/lang/en')}}" class="btn btn-sm {{ app()->getLocale() == 'en' ? 'btn-primary' : 'btn-default' }}" style="padding: 5px 10px;">
                                                    🇬🇧 EN
                                                </a>
                                                <a href="{{url('/lang/pt')}}" class="btn btn-sm {{ app()->getLocale() == 'pt' ? 'btn-primary' : 'btn-default' }}" style="padding: 5px 10px;">
                                                    🇵🇹 PT
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <noscript>
                          ...
                          <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                   <p class="col-md-9 col-sm-9 col-xs-12 copyright"> <a href="#" target="_blank">SAMUGE Suits</a> &copy;<?php echo date("Y");?></p>
                                    <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Developed by:
                                    <a href="https://samuge.com">SAMUGE Suits</a></p>
                                </div>
                            </div>
                        </div>
                      </div>
