...
if (! function_exists('check_license_status')) {
...
if (! function_exists('get_license_expiry')) {
	function get_license_expiry() {
		$license = \App\Models\License::where('status', 'active')->first();
...
if (! function_exists('get_active_license')) {
	function get_active_license() {
		return \App\Models\License::where('status', 'active')->first();
	}
}
